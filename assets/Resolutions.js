...
var Resolutions = {
	...
	HELPER_ID: "WGD_Resolutions_Helper",
	...
	resizeHandler:Events.attach(window, "load", function() {
		Resolutions.screenSetup();
	}),
	...
	screenSetup:function() {
		...
		var self = this;
		//Spawning separate process in hopes of giving helper a chance to render...
	...
	/**
	 * Returns a helper object which is used to more reliably estimate the dimensions of
	 * the viewport.
	 */	
	getHelper:function() {
		var helper = document.getElementById(this.HELPER_ID);
		if (!helper) {
